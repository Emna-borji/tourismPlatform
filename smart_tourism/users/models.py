...
class Preference(models.Model):
    ...
    departure_city = models.ForeignKey("tourism.Destination", on_delete=models.SET_NULL, null=True, related_name="departure_preferences")
    arrival_city = models.ForeignKey("tourism.Destination", on_delete=models.SET_NULL, null=True, related_name="arrival_preferences")
